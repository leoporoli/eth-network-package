...
el_client_context = import_module("github.com/leoporoli/eth-network-package/src/el/el_client_context.star")
el_admin_node_info = import_module("github.com/leoporoli/eth-network-package/src/el/el_admin_node_info.star")
